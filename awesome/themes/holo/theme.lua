...
-- Clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", space3 .. " " .. markup.font("Source Code Pro Bold 10", " %I:%M ")))
...
--    }
    ...
    s.mybottomwibox = awful.wibar({ position = "top", screen = s, border_width = dpi(0), height = dpi(32) })
